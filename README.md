...
#Program implementation using Python 
...
----------------------------------------------------------------.
2. Python Program File Name : Record.py
-----------------------------------------------------------------
...
class Record:
    ...
    def __str__(self):
        ...
        return record
--------------------------------------------------------------------
3.  Python Program File Name : DoubleHashing.py
...
----------------------------------------------------------------
4.  Python Program File Name : main.py
--------------------------------------------------------
